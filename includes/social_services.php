...
$bulkmail_social_services = array(
	'twitter'     => array(
		'name'   => 'Twitter',
		'url'    => 'https://twitter.com/intent/tweet?source=Bulkmail&text=%title&url=%url',
		'width'  => 845,
		'height' => 600,
	),
	'facebook'    => array(
	...
	'delicious'   => array(
		'name'   => 'Delicious',
		'url'    => 'https://delicious.com/save?v=5&provider=Bulkmail&noui&jump=close&url=%url&title=%title',
		'height' => 600,
	),
	'blogger'     => array(
		'name' => 'Blogger',
...
$bulkmail_social_services = apply_filters( 'mymail_social_services', apply_filters( 'bulkmail_social_services', $bulkmail_social_services ) );
